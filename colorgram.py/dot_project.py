...
def main():
    screen = Screen()
    dot.speed("fastest")
    number_of_dot = int(screen.numinput("Admin","How many Dot do you want per line ?: ",default=5, minval=5, maxval=15))
    number_of_line = int(screen.numinput("Admin","How many line do you want? : ", default=1, minval=1, maxval=15))
